...
const Contents = () => {
  return (
    <div className="p-6 bg-gray-100 space-y-9 container mx-auto">

        {/* Section 1 */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mx-auto max-w-7xl mt-10">
...
{/* Large Image Section */}
<div className="relative col-span-1 sm:col-span-2 h-64 md:h-96 lg:h-[600px] bg-gray-300 rounded-lg overflow-hidden shadow-md transition-transform transform hover:scale-105 cursor-pointer">
  {/* Background Image */}
